...
const CardFoodAllRecipe = ({recipe}) => {
    ...
    return (
      ...
      <div className="card-body ">
        ...
        <div className="card-actions justify-center mt-2 py-3">
          <Link to={`/recipe/${idMeal}`}  className="btn border-0 bg-orange-400 hover:bg-blue-500 ">view this Recipes</Link>
        </div>
      </div>
    </div>
      )
...
export default CardFoodAllRecipe